...
| [thecodingmachine/php:7.2-v1-apache-node10](https://github.com/thecodingmachine/docker-images-php/blob/7.2-v1/Dockerfile.apache.node10) | `7.2.x` | apache  | `10.x`           | [![](https://images.microbadger.com/badges/image/thecodingmachine/php:7.2-v1-apache-node10.svg)](https://microbadger.com/images/thecodingmachine/php:7.2-v1-apache-node10)
...
| [thecodingmachine/php:7.2-v1-fpm-node10](https://github.com/thecodingmachine/docker-images-php/blob/7.2-v1/Dockerfile.fpm.node10)       | `7.2.x` | fpm     | `10.x`           | [![](https://images.microbadger.com/badges/image/thecodingmachine/php:7.2-v1-fpm-node10.svg)](https://microbadger.com/images/thecodingmachine/php:7.2-v1-fpm-node10)
...
| [thecodingmachine/php:7.2-v1-cli-node10](https://github.com/thecodingmachine/docker-images-php/blob/7.2-v1/Dockerfile.cli.node10)       | `7.2.x` | cli     | `10.x`           | [![](https://images.microbadger.com/badges/image/thecodingmachine/php:7.2-v1-cli-node10.svg)](https://microbadger.com/images/thecodingmachine/php:7.2-v1-cli-node10)
...
| [thecodingmachine/php:7.1-v1-apache-node10](https://github.com/thecodingmachine/docker-images-php/blob/7.1-v1/Dockerfile.apache.node10) | `7.1.x` | apache  | `10.x`           | [![](https://images.microbadger.com/badges/image/thecodingmachine/php:7.1-v1-apache-node10.svg)](https://microbadger.com/images/thecodingmachine/php:7.1-v1-apache-node10)
...
| [thecodingmachine/php:7.1-v1-fpm-node10](https://github.com/thecodingmachine/docker-images-php/blob/7.1-v1/Dockerfile.fpm.node10)       | `7.1.x` | fpm     | `10.x`           | [![](https://images.microbadger.com/badges/image/thecodingmachine/php:7.1-v1-fpm-node10.svg)](https://microbadger.com/images/thecodingmachine/php:7.1-v1-fpm-node10)
...
| [thecodingmachine/php:7.1-v1-cli-node10](https://github.com/thecodingmachine/docker-images-php/blob/7.1-v1/Dockerfile.cli.node10)       | `7.1.x` | cli     | `10.x`           | [![](https://images.microbadger.com/badges/image/thecodingmachine/php:7.1-v1-cli-node10.svg)](https://microbadger.com/images/thecodingmachine/php:7.1-v1-cli-node10)
...
```bash
$ docker run -p 80:80 --rm --name my-apache-php-app -v "$PWD":/var/www/html thecodingmachine/php:7.2-v1-apache
```

Example with PHP-FPM:

```bash
$ docker run -p 9000:9000 --rm --name my-php-fpm -v "$PWD":/var/www/html thecodingmachine/7.2-v1-fpm
```
