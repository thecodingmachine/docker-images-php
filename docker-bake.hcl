...
group "php82-apache-all" {
   targets = [
     "php82-slim-apache",
     "php82-apache",
     "php82-apache-node18","php82-apache-node16","php82-apache-node14",
   ]
}
group "php82-fpm-all" {
   targets = [
     "php82-slim-fpm",
     "php82-fpm",
     "php82-fpm-node18","php82-fpm-node16","php82-fpm-node14",
   ]
}
group "php82-cli-all" {
   targets = [
     "php82-slim-cli",
     "php82-cli",
     "php82-cli-node18","php82-cli-node16","php82-cli-node14",
   ]
}
group "php81-apache-all" {
   targets = [
     "php81-slim-apache",
     "php81-apache",
     "php81-apache-node18","php81-apache-node16","php81-apache-node14",
   ]
}
group "php81-fpm-all" {
   targets = [
     "php81-slim-fpm",
     "php81-fpm",
     "php81-fpm-node18","php81-fpm-node16","php81-fpm-node14",
   ]
}
group "php81-cli-all" {
   targets = [
     "php81-slim-cli",
     "php81-cli",
     "php81-cli-node18","php81-cli-node16","php81-cli-node14",
   ]
}
group "php80-apache-all" {
   targets = [
     "php80-slim-apache",
     "php80-apache",
     "php80-apache-node18","php80-apache-node16","php80-apache-node14",
   ]
}
group "php80-fpm-all" {
   targets = [
     "php80-slim-fpm",
     "php80-fpm",
     "php80-fpm-node18","php80-fpm-node16","php80-fpm-node14",
   ]
}
group "php80-cli-all" {
   targets = [
     "php80-slim-cli",
     "php80-cli",
     "php80-cli-node18","php80-cli-node16","php80-cli-node14",
   ]
}
group "php74-apache-all" {
   targets = [
     "php74-slim-apache",
     "php74-apache",
     "php74-apache-node18","php74-apache-node16","php74-apache-node14",
   ]
}
group "php74-fpm-all" {
   targets = [
     "php74-slim-fpm",
     "php74-fpm",
     "php74-fpm-node18","php74-fpm-node16","php74-fpm-node14",
   ]
}
group "php74-cli-all" {
   targets = [
     "php74-slim-cli",
     "php74-cli",
     "php74-cli-node18","php74-cli-node16","php74-cli-node14",
   ]
}
group "php73-apache-all" {
   targets = [
     "php73-slim-apache",
     "php73-apache",
     "php73-apache-node18","php73-apache-node16","php73-apache-node14",
   ]
}
group "php73-fpm-all" {
   targets = [
     "php73-slim-fpm",
     "php73-fpm",
     "php73-fpm-node18","php73-fpm-node16","php73-fpm-node14",
   ]
}
group "php73-cli-all" {
   targets = [
     "php73-slim-cli",
     "php73-cli",
     "php73-cli-node18","php73-cli-node16","php73-cli-node14",
   ]
}
group "php72-apache-all" {
   targets = [
     "php72-slim-apache",
     "php72-apache",
     "php72-apache-node18","php72-apache-node16","php72-apache-node14",
   ]
}
group "php72-fpm-all" {
   targets = [
     "php72-slim-fpm",
     "php72-fpm",
     "php72-fpm-node18","php72-fpm-node16","php72-fpm-node14",
   ]
}
group "php72-cli-all" {
   targets = [
     "php72-slim-cli",
     "php72-cli",
     "php72-cli-node18","php72-cli-node16","php72-cli-node14",
   ]
}
...
# thecodingmachine/php:8.2-v5-fpm-node16
...
# thecodingmachine/php:8.2-v5-fpm-node14
...
# thecodingmachine/php:8.2-v5-cli-node16
...
# thecodingmachine/php:8.2-v5-cli-node14
...
# thecodingmachine/php:8.1-v5-fpm-node16
...
# thecodingmachine/php:8.1-v5-fpm-node14
...
# thecodingmachine/php:8.1-v5-cli-node16
...
# thecodingmachine/php:8.1-v5-cli-node14
...
# thecodingmachine/php:8.0-v5-fpm-node18
...
# thecodingmachine/php:8.0-v5-fpm-node16
...
# thecodingmachine/php:8.0-v5-fpm-node14
...
# thecodingmachine/php:8.0-v5-cli-node18
...
# thecodingmachine/php:8.0-v5-cli-node16
...
# thecodingmachine/php:8.0-v5-cli-node14
...
# thecodingmachine/php:7.4-v5-fpm-node18
...
# thecodingmachine/php:7.4-v5-fpm-node16
...
# thecodingmachine/php:7.4-v5-fpm-node14
...
# thecodingmachine/php:7.4-v5-cli-node18
...
# thecodingmachine/php:7.4-v5-cli-node16
...
# thecodingmachine/php:7.4-v5-cli-node14
...
# thecodingmachine/php:7.3-v5-apache
target "php73-apache" {
  inherits = ["default"]
  tags = tag("7.3", "apache")
  dockerfile = "Dockerfile.apache"
...
target "php73-apache-node18" {
  inherits = ["default"]
  tags = tag("7.3", "apache-node18")
  dockerfile = "Dockerfile.apache.node"
  args = {
    PHP_VERSION = "7.3"
    VARIANT = "apache-node18"
...
##    PHP 7.3
###########################
# thecodingmachine/php:7.3-v5-slim-fpm
...
# thecodingmachine/php:7.3-v5-fpm
target "php73-fpm" {
  inherits = ["default"]
  tags = tag("7.3", "fpm")
  dockerfile = "Dockerfile.fpm"
...
# thecodingmachine/php:7.3-v5-fpm-node18
target "php73-fpm-node18" {
  inherits = ["default"]
  tags = tag("7.3", "fpm-node18")
  dockerfile = "Dockerfile.fpm.node"
  args = {
    PHP_VERSION = "7.3"
    VARIANT = "fpm-node18"
...
# thecodingmachine/php:7.3-v5-fpm-node16
...
# thecodingmachine/php:7.3-v5-fpm-node14
...
##    PHP 7.3
###########################
# thecodingmachine/php:7.3-v5-slim-cli
...
# thecodingmachine/php:7.3-v5-cli
target "php73-cli" {
  inherits = ["default"]
  tags = tag("7.3", "cli")
  dockerfile = "Dockerfile.cli"
...
# thecodingmachine/php:7.3-v5-cli-node18
target "php73-cli-node18" {
  inherits = ["default"]
  tags = tag("7.3", "cli-node18")
  dockerfile = "Dockerfile.cli.node"
  args = {
    PHP_VERSION = "7.3"
    VARIANT = "cli-node18"
...
# thecodingmachine/php:7.3-v5-cli-node16
...
# thecodingmachine/php:7.3-v5-cli-node14
...
# thecodingmachine/php:7.2-v5-apache
target "php72-apache" {
  inherits = ["default"]
  tags = tag("7.2", "apache")
  dockerfile = "Dockerfile.apache"
...
target "php72-apache-node18" {
  inherits = ["default"]
  tags = tag("7.2", "apache-node18")
  dockerfile = "Dockerfile.apache.node"
  args = {
    PHP_VERSION = "7.2"
    VARIANT = "apache-node18"
...
##    PHP 7.2
###########################
# thecodingmachine/php:7.2-v5-slim-fpm
...
# thecodingmachine/php:7.2-v5-fpm
target "php72-fpm" {
  inherits = ["default"]
  tags = tag("7.2", "fpm")
  dockerfile = "Dockerfile.fpm"
...
# thecodingmachine/php:7.2-v5-fpm-node18
target "php72-fpm-node18" {
  inherits = ["default"]
  tags = tag("7.2", "fpm-node18")
  dockerfile = "Dockerfile.fpm.node"
  args = {
    PHP_VERSION = "7.2"
    VARIANT = "fpm-node18"
...
# thecodingmachine/php:7.2-v5-fpm-node16
...
# thecodingmachine/php:7.2-v5-fpm-node14
...
##    PHP 7.2
###########################
# thecodingmachine/php:7.2-v5-slim-cli
...
# thecodingmachine/php:7.2-v5-cli
target "php72-cli" {
  inherits = ["default"]
  tags = tag("7.2", "cli")
  dockerfile = "Dockerfile.cli"
...
# thecodingmachine/php:7.2-v5-cli-node18
target "php72-cli-node18" {
  inherits = ["default"]
  tags = tag("7.2", "cli-node18")
  dockerfile = "Dockerfile.cli.node"
  args = {
    PHP_VERSION = "7.2"
    VARIANT = "cli-node18"
...
# thecodingmachine/php:7.2-v5-cli-node16
...
# thecodingmachine/php:7.2-v5-cli-node14
